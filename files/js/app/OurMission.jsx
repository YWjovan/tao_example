class OurMission extends React.Component{
    ...
    render() {
        return (
            <div>
                <h3>Our Mission</h3>
                <p style={{text-align: 'left'}}>Our mission is to create an online ecosystem to help entrepreneurs and SMBs grow and go international. Entrepreneurs have very good ideas, but often lack the resources, talent and support necessary to build them. Every successful business need the right business partners, services, and resources. TaoBase aims to help you facilitate easy and meaningful connections between entrepreneurs, services and resources. TaoBase integrates international directory, online & offline high-quality product and service resources in order to create a lifeline that benefits early stage startups and SMBs, connects established businesses to qualified providers, and empowers all entrepreneurs and businesses to grow.</p>
            </div>
        );
    }
}
